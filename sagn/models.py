...
from sagn.layers import *
# from layers import *
# from layers import FeedForwardNet, GroupMLP, MultiHeadBatchNorm, MultiHeadMLP, MLP
...
class SAGN(nn.Module):
    def __init__(self, in_feats, hidden, out_feats, num_hops, n_layers, num_heads, weight_style="attention", alpha=0.5,
                 focal="first",
        ...
        self.multihop_encoders = nn.ModuleList(
            [GroupMLP(in_feats, hidden, hidden, num_heads, n_layers, dropout) for i in range(num_hops)])
...
class PlainSAGN(nn.Module):
    def __init__(self, in_feats, hidden, out_feats, n_layers, num_heads, residual=True, pre_norm=False,
                 hop_norm="softmax",
        ...
        self.post_encoder = GroupMLP(in_feats * num_heads, hidden, out_feats, num_heads, n_layers, dropout,
                                     residual=residual)
